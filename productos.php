...
<html lang="en">
    <head>
        ...
        <title>Saving Plastic | Página Principal</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="index.php"><img src="assets/img/logo.jpg" class="rounded mx-auto d-block" alt="Logo" width="200px" height="100px"></a>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-3 col-lg-3 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#productagri1">
                            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                                <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                            </div>
                            <img class="img-fluid" src="assets/img/PA1.png" alt="" />
                        </div>
                    </div>
                    <!-- Portfolio Item 2-->
                    <div class="col-md-3 col-lg-3 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#productagri2">
                            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                                <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                            </div>
                            <img class="img-fluid" src="assets/img/PA2.png" alt="" />
                        </div>
                    </div>
                    <!-- Portfolio Item 3-->
                    <div class="col-md-3 col-lg-3 mb-5">
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright © | Saving Plastic 2020</small></div>
        </div>
        ...
        <!-- Portfolio Modals-->
        <!-- Modal 1-->
        <div class="portfolio-modal modal fade" id="productagri1" tabindex="-1" role="dialog" aria-labelledby="productagri1" aria-hidden="true">
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0" id="productagri1">Cajas Mil Usos</h2>
                                    <!-- Icon Divider-->
                                    <div class="divider-custom">
                                        <div class="divider-custom-line"></div>
                                        <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>51 X 31 X 18 h</td>
                                                <td>Naranja, Azul</td>
                                                <td>14 Piezas con Producto</td>
                                            </tr>
                                            <tr>
                                                <td scope="col" class="font-weight-bold">Forma de Estiba / Empaque:</td>
                                                <td scope="col" class="font-weight-bold">Capacidad:</td>
                                                <td scope="col" class="font-weight-bold">Servicios:</td>
                                            </tr>
                                            <tr>
                                                <td>Apilable</td>
                                                <td>
                    ...
                    <div class="modal-body text-center">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <!-- Portfolio Modal - Title-->
                                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0" id="productagri2">Caja Lechera de 16 Litros</h2>
                                    <!-- Icon Divider-->
                                    <div class="divider-custom">
                                        <div class="divider-custom-line"></div>
                                        <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                    ...
                                    <table class="table table-hover table-bordered table-sm table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>34 X 34 X 27 h</td>
                                                <td>Azul</td>
                                                <td>10 Piezas con Producto</td>
                                            </tr>
                                            <tr>
